...
>
> → Última release: [v2.1.0](https://github.com/produtoreativo/prodops-framework/releases/tag/v2.1.0)
...
bash /tmp/prodops-framework/prodops/scripts/install-prodops.sh --version v2.1.0 --target /caminho/do/repo
```
...
bash prodops/scripts/sync-from-framework.sh --version v2.1.0
