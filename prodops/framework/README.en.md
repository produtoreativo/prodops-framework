...
| [contributor-philosophy.en.md](contributor-philosophy.en.md) | **Contributor philosophy** — where each change belongs (Framework vs Runtime vs Agents), the four design qualifiers, and how to evolve without accumulating inconsistency |
