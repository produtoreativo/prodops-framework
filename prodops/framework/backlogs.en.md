...
**What it is:** Governance process responsible for partitioning the Global OBC into Local OBCs — one per involved product. Occurs after Discovery in the BIB, before creating items in the products' Product Backlogs. Not a Framework Capability — it is a one-time activity, the responsibility of the Portfolio PM + Tech Leads.
