# OBC Template — Use the correct template

The OBC model has evolved to two levels. This file exists for historical reference only.
...
**Use `global-obc.en.md` when:**
- The Intent has just entered the Business Intent Backlog
- You are documenting the strategic platform contract
- The owner is the Portfolio PM
...
→ [Glossary: Global OBC, Local OBC, OBC Partitioning](../../framework/glossary.en.md)
